...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ab.addTab(ab.newTab().setText("News Feed").setTabListener(this));
        ab.addTab(ab.newTab().setText("Exhibits").setTabListener(this));
        ab.addTab(ab.newTab().setText("Map").setTabListener(this));
        ab.addTab(ab.newTab().setText("Credits").setTabListener(this));
    }
