...
public void mousePressed() {
  ...
  public void discoveryCenter() {
      ...
      sendBroadcast(intent);
      Log.w("myApp", "discoveryCenter");

  }
  public void discoveryLab() {
    background(255,247,114);
      Log.w("myApp", "discoveryLab");
  }
  public void ecoScapes() {
    //background(255,247,114);
      ...
      sendBroadcast(intent);
      Log.w("myApp", "ecoScapes");

      //Intent intent = new Intent("com.arcdevices.instatemp");
