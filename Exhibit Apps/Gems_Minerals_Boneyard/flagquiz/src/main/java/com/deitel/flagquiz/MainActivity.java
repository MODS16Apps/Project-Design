...
public class MainActivity extends Activity
{
   ...
   public static final String MINERALS = "pref_regionsToInclude";
   ...
   {
      super.onStart(); if (preferencesChanged)
   {
   ...
   private OnSharedPreferenceChangeListener preferenceChangeListener =
           new OnSharedPreferenceChangeListener()
           {
                      ...
                      SharedPreferences sharedPreferences, String key)
              {
                 ...
                 else if (key.equals(MINERALS)) // regions to include changed
                 {
                    Set<String> regions =
                            sharedPreferences.getStringSet(MINERALS, null);
                    ...
                    else // must select one region--set North America as default
                    {
                       ...
                       regions.add(
                               getResources().getString(R.string.default_mineral));
                       editor.putStringSet(MINERALS, regions);
                       editor.commit();
                       Toast.makeText(MainActivity.this,
                               R.string.default_mineral_message,
